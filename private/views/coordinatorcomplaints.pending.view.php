...
body{
        ...
        <div class="table">
            <div class="table_header">
                <div style="display: flex;" >
                    <h3>  Complaints on <?=$rows["complaint_type"]?> </h3>
                </div>
            ...
            <div class="table_section">
                <table>
                    ...
                    <tbody>
                        ...
                        <pre>
                            <?php print_r($rows['complaints']);?>
                        </pre>
                        <?php foreach ($rows["complaints"] as $row) :?>
                            <?php print_r("ROOT/coordinatorviewcomplaints/seemore/$row->id");?>
    ...
    <?php else:?>
        <h4>No Complaints on <?=$rows["complaint_type"]?>.</h4>
        <br><br>
    <?php endif;?> 
