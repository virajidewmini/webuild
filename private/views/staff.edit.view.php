...
body{
    ...
    <form method="post">
        ...
        <?php if(count($errors) >0):?>
            ...
            <?php endforeach; ?>
        <?php endif;?>
        <input name="staffid" value= "<?= get_var('staffid',$row[0]->staffid);?>" type="text" placeholder="Staff ID" class="">
        <br>
        <br>
        ...
        <br>
        <br>
        <select name="role" value="<?= get_var('role',$row[0]->role);?>" type="text" placeholder="Role" class="">
        ...
        <br>
        <a href="<?=ROOT?>/staff">
            <input type="submit" value="Save"class="">  <input type="button" value="Cancel"class="">
        </a>
