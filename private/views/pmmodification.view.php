    ...
    <?php if (true) : ?>
                            ...
                            <div class="unit-d">
                                ...
                                <div>
                                    ...
                                    <div class="e-id-d" style="display:flex;align-items: center;">
                                        ...
                                        <input readonly style="width:150px;" type="text" value="<?= $interest ?> %" class="interestp" name="interestp">
                                    </div>
                                    <div class="unit">
                                        <h4>Interest :</h4>
                                    </div>
                                    <div class="e-id-d" style="display:flex;align-items: center;">
                                        <p style="margin-left: 20px">Rs.</p>
                                        <input readonly style="width:150px;" type="text" class="interest" name="interest">
                                    </div>
                                    <div class="unit">
                                        <h4>Total price :</h4>
                                    </div>
                                    <div class="e-id-d" style="display:flex;align-items: center;">
                                        <p style="margin-left: 20px">Rs.</p>
                                        <input readonly style="width:150px;" type="text" class="totalprice" name="totalprice">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            function Price() {
                ...
                var interestp = document.getElementsByClassName('interestp');
                document.querySelector(".interest").value = parseInt((parseFloat(newprice[0].value) * (parseFloat(interestp[0].value) / 100)));

                var interest = document.getElementsByClassName('interest');
                document.querySelector(".totalprice").value = (parseFloat(newprice[0].value)) + (parseFloat(interest[0].value));
            }
