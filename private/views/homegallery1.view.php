...
<section class="blogs" id="blogs" style="margin-top: 2rem;">
  ...
  <div class="swiper home-slider">
    <div class="swiper-wrapper">
      <section class="swiper-slide slide" style="background: url(<?=ROOT?>/img/Photos/bedrooms/3d-rendering-modern-luxury-bedroom-suite-bathroom_105762-1945.jpg) no-repeat;padding-bottom:3rem;height: 2px;width:100%;">
        
      </section>
      <section class="swiper-slide slide" style="background: url(<?=ROOT?>/img/Photos/kitchen/k2.jpg) no-repeat;padding-bottom:3rem;height: 2px;">
        
      </section>
      <section class="swiper-slide slide" style="background: url(<?=ROOT?>/img/Photos/bathroom/tidy-bathroom-with-shiny-tiles_1203-1501.jpg) no-repeat;padding-bottom:3rem;height: 2px;  object-fit:cover;">
...
<section class="floorplan" id="floorplan" style="background-color: azure;">
  ...
  <div class="floorimg"  style="justify-content: center;">
    <img src="<?=ROOT?>/img/Photos/Floorpaln/FP1.jpg" alt=""  style="justify-content: center;">
  </div>
...
<section class="blockplan" id="blockplan">
  ...
  <div class="floorimg">
    <img src="<?=ROOT?>/img/Photos/blockPlan/210717130751blockplan.jpg " alt="">
  </div>
  
</section>

    
<a class="btn" href="<?=ROOT?>/submitModel"  style="background-color: #E5863D; padding:1rem ;font-size: 1rem; ;margin-left:100%; margin-bottom:2rem;">Move to Model</a>
