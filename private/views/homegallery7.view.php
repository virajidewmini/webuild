  ...
  <section class="home" id="home">
    ...
    <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
        ...
        <section class="swiper-slide slide" style="background: url(<?=ROOT?>/img/Photos/bathroom/canva10.jpg)no-repeat; width:100%; height:100%;">
...
<section class="blogs" id="blogs" style="margin-top: 2rem;">
  ...
  <div class="swiper home-slider">
    <div class="swiper-wrapper">
      <section class="swiper-slide slide" style="background: url(<?=ROOT?>/img/Photos/bedrooms/3d-rendering-modern-luxury-bedroom-suite-bathroom_105762-1945.jpg) no-repeat;padding-bottom:3rem;height: 2px;object-fit:cover;">
...
<section class="floorplan" id="floorplan" style="background-color: azure;">
  ...
  <div class="floorimg"  style="justify-content: center;">
    <img src="<?=ROOT?>/img/Photos/Floorpaln/210803140801B1.jpg" alt=""  style="justify-content: center;">
  </div>
...
<section class="blockplan" id="blockplan">
  ...
  <div class="floorimg">
    <img src="<?=ROOT?>/img/Photos/blockPlan/210727150746blockplan.jpg" alt="">
  </div>
