...
<section class="home">
  <div class="swiper home-slider">
    <div class="swiper-wrapper">
      <div class="swiper-slide slide " style="background: url(./Photos/Houses/1_Floor/free-photo-of-brown-leather-seats-in-a-modernist-interior.jpeg);">
        <div class="content">
...
<div class="slide" style="background: url(./Photos/)">
  <div class="content">
    <section class="booking">
      <h1 class="heading-title">choose your one</h1>
      <div class="flex">
        <div class="select-container">
          <span>District</span><br>
          <select name="district" id="" class="select-box">
            <option value="Galle">Select District</option>
