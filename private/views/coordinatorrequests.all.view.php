...
<br><?php print_r($rows['rejected_requests_count'][0]->total); ?> -->
                <div id="pdf">
                    ...
                    <div style="text-align: center;">
                        <h2 style="margin-top: 20px;margin-bottom: 20px">Analysis of All Project Requests Recieved in the Year <h2 id="year"><?= $rows['year']; ?></h2></h2>
                    </div>
                    <div class="main">
    ...
    <script>
        function calculate() {
            ...
            $('#print').click(function(e) {
                ...
                const name = 'Analysis of Project Requests ' + $('#year').text();
                options.filename = name +'.pdf';
                html2pdf().from(element).set(options).save().then(() => {

                    window.location.href = 'http://localhost:3308/webuild/public/coordinatorrequests';
