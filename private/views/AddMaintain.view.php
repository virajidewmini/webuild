...
<div style="margin-left: 285px;" class="table_header" >
    ...
    <div class="form_container">
        <form method="post"  class="v_form">
            <label class="v_label" id="complaintType">Material Name</label>
            ...
            <label for="description">Total Quntity</label>
            <label for="description">Current Quantity</label>
            <a href="#"><label for="description">Request</label></a>
